        ...
        <div class="kegiatan-card">
            <form action="../server/proses/event/TambahEvent.php" method="post" enctype="multipart/form-data" class="kegiatan-form">
                <div class="kegiatan-group">
                    ...
                    <span id="nama-kegiatan-error" class="error-message font-semi-bold"></span>
                </div>
                    ...
                    <div class="kegiatan-input-file-container">
                        <label for="dropzone-file" class="kegiatan-input-file-label">
                            <div class="kegiatan-input-file-content">
                                <!-- Preview gambar yang akan ditampilkan setelah upload -->
                                <img id="poster-kompetisi-preview" class="hidden kegiatan-file-preview" alt="Preview Poster" />
                                
                                <!-- Ikon default saat belum ada file -->
                                ...
                                <!-- Teks instruksi sebelum file dipilih -->
                                ...
                                <!-- Teks tambahan dengan informasi tipe file -->
                                <p id="file-subtext-kompetisi" class="kegiatan-input-file-subtext font-semi-bold">SVG, PNG, JPG or GIF (MAX. 800x400px)</p>
                            </div>
                            <input id="dropzone-file" name="poster-kompetisi" type="file" class="kegiatan-input-file-hidden" />
                        </label>
                    </div>
                </div>
                <div class="actions">

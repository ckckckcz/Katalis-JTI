    ...
    <div class="admin-container">
        ...
        <div class="kegiatan-card">
            <form action="" class="kegiatan-form">
                <label for="studi-kegiatan" class="kegiatan-label font-bold">Jenis Kompetisi</label>
                <div class="prestasi-inline-flex" role="group">
                    <button type="button" class="prestasi-button font-bold prestasi-button-left">
                    ...
                    <button type="button" class="prestasi-button font-bold prestasi-button-middle">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="prestasi-icon">
                            <path fill-rule="evenodd"
                    ...
                    <button type="button" class="prestasi-button font-bold prestasi-button-middle-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="prestasi-icon">
                            <path fill-rule="evenodd"
                    ...
                    <button type="button" class="prestasi-button font-bold prestasi-button-right">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="prestasi-icon">
                            <path fill-rule="evenodd"
                ...
                <div class="kegiatan-grid">
                    <div class="kegiatan-group">
                        <label for="Tingkat" class="kegiatan-label font-bold">Nomor Surat Tugas</label>
                        <input type="text" id="nama-kompetisi" class="kegiatan-input font-semi-bold"
                            placeholder="Masukkan nama kompetisi">
                    </div>
                    <div class="kegiatan-group">
                        <label for="Tingkat" class="kegiatan-label font-bold">Tanggal Surat Tugas</label>
                        <input type="date" id="nama-kompetisi" class="kegiatan-input font-semi-bold"
                            placeholder="Masukkan nama kompetisi">
                    </div>
                </div>
                <div class="kegiatan-group">
                    <label for="nama-kompetisi" class="kegiatan-label font-bold">Jumlah Peserta</label>
                    <input type="text" id="nama-kompetisi" class="kegiatan-input font-semi-bold"
                        placeholder="Masukkan nama kompetisi">
                </div>
                <div class="kegiatan-grid">
                    <div class="kegiatan-group">
                        <label for="nama-kompetisi" class="kegiatan-label font-bold">File Surat Tugas</label>
                    ...
                    <div class="kegiatan-group">
                        <label for="nama-kompetisi" class="kegiatan-label font-bold">File Sertifikat</label>
                        <div class="kegiatan-input-file-container">
                            <label for="dropzone-file" class="kegiatan-input-file-label">
                                <div class="kegiatan-input-file-content">
                                    <svg class="kegiatan-input-file-icon" aria-hidden="true"
                    ...
                    <div class="kegiatan-group">
                        <label for="nama-kompetisi" class="kegiatan-label font-bold">Foto Kegiatan</label>
                        <div class="kegiatan-input-file-container">
                            <label for="dropzone-file" class="kegiatan-input-file-label">
                                <div class="kegiatan-input-file-content">
                                    <svg class="kegiatan-input-file-icon" aria-hidden="true"

...
<section class="admin-section">
    <div class="admin-container">
        ...
        <div class="kegiatan-card">
            <form action="../server/proses/prestasi/TambahPrestasi.php" method="post" enctype="multipart/form-data"
                class="kegiatan-form">
                ...
                <div class="kegiatan-grid">
                    ...
                    <div class="kegiatan-group">
                        ...
                        <input type="text" id="dosen-pembimbing" name="dosen-pembimbing"
                            class="kegiatan-input font-semi-bold" placeholder="Masukkan nama dosen pembimbing">
                    </div>
                </div>
                <div class="kegiatan-grid">
                    <div class="kegiatan-group">

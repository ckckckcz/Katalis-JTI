...
<div id="toast-success"
    ...
    <div class="ms-3 text-sm font-normal">Pendaftaran berhasil.</div>
    <button type="button"
...
<div id="toast-danger"
    ...
    <div class="ms-3 text-sm font-normal">Pendaftaran gagal. Email sudah terdaftar</div>
    <button type="button"
        class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg p-1.5 hover:bg-gray-100"
...
<script>
    window.onload = function () {
        // Check if session has register success or error

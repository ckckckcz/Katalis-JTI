...
<div class="sidebar-background-mobile hidden" id="sidebarBackground">
    <div class="sidebar-container">
        ...
        <ul class="sidebar-ul">
            <li class="sidebar-li">
                <div onclick="window.location.href='/katalis/user'" class="sidebar-link-mobile">
            ...
            <li class="sidebar-li">
                <div onclick="window.location.href='/katalis/user/daftarPrestasi'" class="sidebar-link-mobile">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="sidebar-svg">
                        <path
                    ...
                    <span class="sidebar-text font-bold">Daftar Prestasi</span>
                </div>
            </li>
            <li class="sidebar-li">

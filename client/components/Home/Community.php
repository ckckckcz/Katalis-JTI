<section class="bg-white dark:bg-gray-900">
    <div class=" text-left grid grid-cols-2">
        <div class="bg-red-700 p-10 text-5xl text-white flex flex-col justify-center items-start">
            <h5 class="mb-10">JOIN GRIT & GRIND FAMILY</h5>
            <div class="socialMedia gap-2 flex justify-start">
                <div
                    class="bg-white text-red-600 hover:rounded-lg hover:bg-red-800 hover:text-white p-5 transition-all duration-300 ease-in-out">
        ...
        <img src="/UTS/public/img/backgroundHome.png" alt="">
    </div>
</section>
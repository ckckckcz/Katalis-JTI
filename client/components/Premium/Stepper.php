<div class="flex justify-center items-center">
    <ol class="flex items-center space-x-12 w-full max-w-5xl">
        ...
        <li class="flex items-center gap-x-4 text-gray-500 dark:text-gray-400">
            <span
        ...
        <li class="flex items-center gap-x-4 text-gray-500 dark:text-gray-400">
            ...
            <span>
                <h3 class="font-medium text-lg leading-tight roboto-medium">Document Information</h3>
                <p class="text-sm roboto-medium">Step details here</p>
            </span>
        </li>
        <li class="flex items-center gap-x-4 text-gray-500 dark:text-gray-400">
            ...
            <span>
                <h3 class="font-medium text-lg leading-tight roboto-medium">Confirm Registration</h3>
                <p class="text-sm roboto-medium">Step details here</p>
            </span>
        </li>
    </ol>
